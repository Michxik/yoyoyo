...
export default function AddVehiclePage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Generowanie ID na podstawie nazwy (slug)
      ...
      <section className="w-full py-12 md:py-24 bg-white">
        <div className="container px-4 md:px-6">
          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center mb-8">
            ...
            <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl">Dodaj Nowy Pojazd</h1>
            <p className="max-w-[700px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed font-sans">
              Wypełnij formularz, aby dodać nowy pojazd do oferty
            </p>
          </div>
